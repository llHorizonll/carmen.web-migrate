...
- Name: gl/journal-voucher.spec.ts >> GL Journal Voucher Create Page >> create form loads without errors
- Location: tests/e2e/gl/journal-voucher.spec.ts:172:3
...
Locator: getByText(/create journal voucher/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/create journal voucher/i)
