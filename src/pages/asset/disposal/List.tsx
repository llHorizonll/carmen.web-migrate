...
import { useAssetDisposalList } from '../../../hooks/useAssetRegister';
import { formatDate, formatCurrency } from '../../../utils/formatter';
import type { AssetRegister } from '../../../types';
import type { ColumnDef } from '@tanstack/react-table';

export default function AssetDisposalList() {
  ...
  const { data, isLoading } = useAssetDisposalList({
    Page: filters.Page,
    Limit: filters.Limit,
  ...
  const handleRowClick = (row: AssetRegister) => {
    navigate(`/asset/disposal/${row.AssetId}`);
  };
  ...
  return (
    <div>
      <PageHeader
        ...
        subtitle="Manage disposed and sold assets"
        breadcrumbs={[
        ...
        actions={
          <Button
            ...
            onClick={() => navigate('/asset/disposal/new')}
          >
            New Disposal
          </Button>
        }
