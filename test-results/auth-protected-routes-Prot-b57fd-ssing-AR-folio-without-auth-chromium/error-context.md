...
- Name: auth/protected-routes.spec.ts >> Protected Routes - Redirect to Login >> should redirect to login when accessing AR folio without auth
- Location: tests/e2e/auth/protected-routes.spec.ts:76:3
