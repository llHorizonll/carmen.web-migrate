...
- Name: auth/protected-routes.spec.ts >> Protected Routes - Authenticated Access >> should access GL journal voucher list when authenticated
- Location: tests/e2e/auth/protected-routes.spec.ts:192:3
