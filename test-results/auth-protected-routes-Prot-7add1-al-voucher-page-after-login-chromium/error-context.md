...
- Name: auth/protected-routes.spec.ts >> Protected Routes - Redirect After Login >> should redirect back to GL journal voucher page after login
- Location: tests/e2e/auth/protected-routes.spec.ts:145:3
