...
- Name: ap/payment.spec.ts >> AP Payment List Page >> new payment button navigates to create page
- Location: tests/e2e/ap/payment.spec.ts:31:3
...
Locator: getByRole('button', { name: /new payment/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /new payment/i })
