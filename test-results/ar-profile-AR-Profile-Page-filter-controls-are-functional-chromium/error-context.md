...
- Name: ar/profile.spec.ts >> AR Profile Page >> filter controls are functional
- Location: tests/e2e/ar/profile.spec.ts:41:3
...
Call log:
  ...
  - waiting for getByLabel('AR Type')
