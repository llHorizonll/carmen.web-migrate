...
- Name: gl/journal-voucher.spec.ts >> GL Journal Voucher List Page >> create JV button navigates to create page
- Location: tests/e2e/gl/journal-voucher.spec.ts:30:3
...
Locator: getByRole('button', { name: /create jv|new/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /create jv|new/i })
