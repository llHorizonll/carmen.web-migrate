...
- Name: gl/journal-voucher.spec.ts >> GL Journal Voucher List Page >> page loads without errors
- Location: tests/e2e/gl/journal-voucher.spec.ts:14:3
...
Locator: getByText('Journal Vouchers')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Journal Vouchers')
