...
- Name: gl/journal-voucher.spec.ts >> GL Journal Voucher Create Page >> form validation works
- Location: tests/e2e/gl/journal-voucher.spec.ts:187:3
...
Call log:
  - waiting for getByRole('button', { name: /create|save|submit/i })
