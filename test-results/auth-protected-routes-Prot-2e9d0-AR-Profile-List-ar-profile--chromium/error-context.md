...
- Name: auth/protected-routes.spec.ts >> Protected Routes - All Routes Coverage >> should require auth for AR Profile List (/ar/profile)
...
Received string:  "http://localhost:5173/ar/profile"
Timeout: 5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    8 × unexpected value "http://localhost:5173/ar/profile"
