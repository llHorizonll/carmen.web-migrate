...
- Name: auth/protected-routes.spec.ts >> Protected Routes - Redirect After Login >> should redirect back to dashboard after successful login
- Location: tests/e2e/auth/protected-routes.spec.ts:127:3
