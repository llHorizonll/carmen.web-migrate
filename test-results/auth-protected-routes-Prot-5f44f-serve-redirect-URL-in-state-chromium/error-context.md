...
- Name: auth/protected-routes.spec.ts >> Protected Routes - Redirect to Login >> should preserve redirect URL in state
- Location: tests/e2e/auth/protected-routes.spec.ts:84:3
