...
- Name: ar/invoice.spec.ts >> AR Invoice List Page >> new invoice button navigates to create page
- Location: tests/e2e/ar/invoice.spec.ts:31:3
...
Locator: getByRole('button', { name: /new invoice/i })
Expected: visible
Timeout: 5000ms
