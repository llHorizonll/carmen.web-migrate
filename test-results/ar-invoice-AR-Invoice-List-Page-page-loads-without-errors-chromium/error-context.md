...
- Name: ar/invoice.spec.ts >> AR Invoice List Page >> page loads without errors
- Location: tests/e2e/ar/invoice.spec.ts:14:3
...
Call log:
  ...
  - waiting for getByText('AR Invoices')
