...
- Name: ar/folio.spec.ts >> AR Folio Page >> displays totals section when data exists
- Location: tests/e2e/ar/folio.spec.ts:64:3
...
Locator: getByText('Total Debit').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Total Debit').first()
