...
- Name: auth/protected-routes.spec.ts >> Protected Routes - All Routes Coverage >> should require auth for AR Receipt Create (/ar/receipt/new)
...
Received string:  "http://localhost:5173/ar/receipt/new"
Timeout: 5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    9 × unexpected value "http://localhost:5173/ar/receipt/new"
