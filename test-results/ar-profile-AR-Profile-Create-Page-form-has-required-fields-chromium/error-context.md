...
- Name: ar/profile.spec.ts >> AR Profile Create Page >> form has required fields
- Location: tests/e2e/ar/profile.spec.ts:127:3
...
Locator: getByLabel('Profile Code').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByLabel('Profile Code').first()
