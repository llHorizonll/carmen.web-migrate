...
- Name: auth/protected-routes.spec.ts >> Protected Routes - Authenticated Access >> should access AP modules when authenticated
- Location: tests/e2e/auth/protected-routes.spec.ts:225:3
