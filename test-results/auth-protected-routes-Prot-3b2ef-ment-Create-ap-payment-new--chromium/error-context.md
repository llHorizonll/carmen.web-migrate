...
- Name: auth/protected-routes.spec.ts >> Protected Routes - All Routes Coverage >> should require auth for AP Payment Create (/ap/payment/new)
...
Received string:  "http://localhost:5173/ap/payment/new"
Timeout: 5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    9 × unexpected value "http://localhost:5173/ap/payment/new"
