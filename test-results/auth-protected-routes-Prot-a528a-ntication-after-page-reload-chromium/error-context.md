...
- Name: auth/protected-routes.spec.ts >> Protected Routes - Token Persistence >> should maintain authentication after page reload
- Location: tests/e2e/auth/protected-routes.spec.ts:253:3
