...
- Name: auth/protected-routes.spec.ts >> Protected Routes - Authenticated Access >> should access AR folio when authenticated
- Location: tests/e2e/auth/protected-routes.spec.ts:187:3
