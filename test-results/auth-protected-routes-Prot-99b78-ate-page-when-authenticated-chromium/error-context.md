...
- Name: auth/protected-routes.spec.ts >> Protected Routes - Authenticated Access >> should access AR invoice create page when authenticated
- Location: tests/e2e/auth/protected-routes.spec.ts:204:3
