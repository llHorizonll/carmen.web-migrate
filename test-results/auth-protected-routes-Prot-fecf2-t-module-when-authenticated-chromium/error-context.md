...
- Name: auth/protected-routes.spec.ts >> Protected Routes - Authenticated Access >> should access Asset module when authenticated
- Location: tests/e2e/auth/protected-routes.spec.ts:236:3
