...
- Name: gl/journal-voucher.spec.ts >> GL Journal Voucher Create Page >> cancel button returns to list
- Location: tests/e2e/gl/journal-voucher.spec.ts:196:3
...
Locator: getByRole('button', { name: /cancel/i })
Expected: visible
Timeout: 5000ms
