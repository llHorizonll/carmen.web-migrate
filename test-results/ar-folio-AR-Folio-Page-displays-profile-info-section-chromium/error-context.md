...
- Name: ar/folio.spec.ts >> AR Folio Page >> displays profile info section
- Location: tests/e2e/ar/folio.spec.ts:33:3
...
Locator: getByText('Profile Code')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Profile Code')
